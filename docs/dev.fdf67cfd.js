...
exports.default = {
  ...
  computed: {
    headerDateText: function headerDateText() {
      if (this.mode === 'week') {
        var startDay = (0, _dayjs2.default)(this.formatedDay).startOf('week').format('YYYY-MM-DD');
        var endDay = (0, _dayjs2.default)(this.formatedDay).endOf('week').format('YYYY-MM-DD');
        return startDay + ' - ' + endDay;
      } else {
        return (0, _dayjs2.default)(this.formatedDay).format('YYYY-MM');
      }
    }
  },
  methods: {
      ...
      var _loop = function _loop(day) {
        ...
        if (dataType === '[object Object]') {
          Object.keys(dateData).forEach(function (item) {
            if (monthViewStartDate.isSame((0, _dayjs2.default)(new Date(item)), 'day')) {
              data.push(dateData[item]);
            }
          });
        } else if (dataType === '[object Array]') {
          data = dateData.filter(function (item) {
            return monthViewStartDate.isSame((0, _dayjs2.default)(new Date(item[_this.matchKey])), 'day');
          });
        }
