  ...
  !function (e, t) {
    ...
    function e() {
      ...
      return e.isValid() ? (t = R(t, e.localeData()), ot[t] = ot[t] || function (e) {
        var t,
            n,
            s = e.match(rt);for (t = 0, n = s.length; t < n; t++) {
      ...
      }var s = 5;for (at.lastIndex = 0; s >= 0 && at.test(e);) {
      ...
      var n,
          s = t;for ("string" == typeof e && (e = [e]), i(t) && (s = function s(e, n) {
        n[t] = g(e);
      }), n = 0; n < e.length; n++) {
        Ot[e[n]] = s;
      }
      ...
      var t = null;if (!Xt[e] && "undefined" != 'object' && module && module.exports) try {
        t = Jt._abbr;commonjsRequire("./locale/" + e), ae(t);
      } catch (e) {}return Xt[e];
    }function ae(e, t) {
      ...
      if (t._f !== e.ISO_8601) {
        if (t._f !== e.RFC_2822) {
          t._a = [], d(t).empty = !0;var n,
              ...
              o = "" + t._i,
              u = o.length,
              l = 0;for (i = R(t._f, t._locale).match(rt) || [], n = 0; n < i.length; n++) {
      ...
      var l = o._i,
        ...
        var t, n, s, i, r;if (0 === e._f.length) return d(e).invalidFormat = !0, void (e._d = new Date(NaN));for (i = 0; i < e._f.length; i++) {
      ...
      var s, i;if (1 === n.length && t(n[0]) && (n = n[0]), !n.length) return pe();for (s = n[0], i = 1; i < n.length; ++i) {
      ...
      var n,
          ...
          r,
          a = e,
          u = null;return Me(e) ? a = { ms: e._milliseconds, d: e._days, M: e._months } : i(e) ? (a = {}, t ? a[t] = e : a.milliseconds = e) : (u = fn.exec(e)) ? (n = "-" === u[1] ? -1 : 1, a = { y: 0, d: g(u[bt]) * n, h: g(u[Pt]) * n, m: g(u[Wt]) * n, s: g(u[Ht]) * n, ms: g(Se(1e3 * u[Rt])) * n }) : (u = mn.exec(e)) ? (n = "-" === u[1] ? -1 : (u[1], 1), a = { y: be(u[2], n), M: be(u[3], n), w: be(u[4], n), d: be(u[5], n), h: be(u[6], n), m: be(u[7], n), s: be(u[8], n) }) : null == a ? a = {} : "object" == (typeof a === 'undefined' ? 'undefined' : _typeof(a)) && ("from" in a || "to" in a) && (r = function (e, t) {
    ...
    }), Y("millisecond", "ms"), x("millisecond", 16), C("S", gt, lt), C("SS", gt, dt), C("SSS", gt, ht);var Mn;for (Mn = "SSSS"; Mn.length <= 9; Mn += "S") {
      C(Mn, vt);
    }for (Mn = "S"; Mn.length <= 9; Mn += "S") {
      L(Mn, Ne);
    }var Sn = I("Milliseconds", !1);P("z", 0, 0, "zoneAbbr"), P("zz", 0, 0, "zoneName");var Dn = m.prototype;Dn.add = _n, Dn.calendar = function (t, n) {
      var s = t || pe(),
      ...
      if ("object" == (typeof e === 'undefined' ? 'undefined' : _typeof(e))) for (var n = function (e) {
        var t = [];for (var n in e) {
          t.push({ unit: n, priority: it[n] });
        }return t.sort(function (e, t) {
          return e.priority - t.priority;
        }), t;
      }(e = T(e)), s = 0; s < n.length; s++) {
        this[n[s].unit](e[n[s].unit]);
      } else if (e = O(e), S(this[e])) return this[e](t);return this;
    ...
    }, ae("en", { dayOfMonthOrdinalParse: /\d{1,2}(th|st|nd|rd)/, ordinal: function ordinal(e) {
...
},{"vueify/lib/insert-css":14,"../vue2-event-calendar":233,"../default.css":6,"./data":8,"vue-hot-reload-api":13,"vue":11}],2:[function(require,module,exports) {
'use strict';
...
},{"vue":11,"./App.vue":4}],0:[function(require,module,exports) {
var global = (1, eval)('this');
...
if (!module.bundle.parent && typeof WebSocket !== 'undefined') {
  var ws = new WebSocket('ws://localhost:50047/');
